...
# To demonstrate how this works, we'll create a data frame which has the same inputs 
# that we included for the deterministic model 
...
# The code to create a data frame is then been wrapped into a function.
# This will enable us to create a data frame with a certain number of simulations and cost of treatment.
