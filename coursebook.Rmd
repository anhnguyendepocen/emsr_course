...
You can find all materials from this short course on our [Github Repository](https://github.com/RobertASmith/shiny_healthy_economics). Feel free to use any code from this repository, but make sure you cite the following peer reviewed article: 
...
This short course is designed to provide the participant with a basic set of tools to make user-interfaces for health economic models constructed in R. The aim is to ensure delegates understand the basic functionality of a Health Economic Evaluation Model constructed in R and displayed in a user-interface created in R-Shiny. 
