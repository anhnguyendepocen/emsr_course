...
# < INSERT CODE HERE FOR ITERATIONS > #

cep_plot

#====================================================#
# 3. Insert code for means
cep_plot <- cep_plot + 
...
cep_plot = cep_plot + 
  ...
  labs(title = "Cost-effectiveness Plane",
       subtitle = "Results of Probabilistic Sensitivity Analysis") +
...
# quick solution, just overwrite with new theme. 
plotCEP(results = df_results) + theme_dark()
...
plotCEP(results = f_wrapper(c_Trt = 300))
