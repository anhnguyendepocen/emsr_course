...
# HAVE ADDED 1) Updated ICER
#            2) With progress.
#            3) Slider range for age.
...
ui <- fluidPage(    # create user interface using fluid-page function
  ...
  sidebarLayout(    # indicates layout is going to be a sidebar-layout
    ...
    mainPanel(                                # open main panel
      ...
      h3("Cost-effectiveness Acceptability Curve"),         # heading (Cost effectiveness plane)
      
      plotOutput(outputId = "SO_CEAC")       # plotOutput id = CE_plane, from server
